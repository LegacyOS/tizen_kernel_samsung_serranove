...
#ifdef CONFIG_TIZEN_WIP
		/* When Gear Circle headset initiate connection then it was taking time
		  * to connect. As per Qualcomm specified in QC Case 02215206 avoid
		  * role switch for only this headset */
		if ((cp.bdaddr.b[5] == 0x10 || cp.bdaddr.b[5] == 0xA8) &&
				(cp.bdaddr.b[4] == 0x92 || cp.bdaddr.b[4] == 0x9F) &&
				(cp.bdaddr.b[3] == 0x66 || cp.bdaddr.b[3] == 0xBA)) {
