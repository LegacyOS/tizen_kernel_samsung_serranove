...
/*
 * 0x17 reserved for DRM_KGSL_GEM_CP_HANDLE
 */
#define DRM_KGSL_DRM_SET_DFPS 0x18
...
#define DRM_IOCTL_KGSL_DRM_SET_DFPS \
DRM_IOWR(DRM_COMMAND_BASE + DRM_KGSL_DRM_SET_DFPS, \
struct drm_kgsl_vblank_fps)
...
#ifdef __KERNEL__
/* definition of nb event */
enum kgsl_drm_notifier {
	KGSL_DRM_GET_CRTC_INFO,
	KGSL_DRM_SET_CLK,
	KGSL_DRM_SET_VSYNC,
};

struct kgsl_drm_crtc_info {
	__u32 hsize;
	__u32 vsize;
	__u32 refresh;
	__u32 runtime_vsync;
