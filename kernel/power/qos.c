...
static BLOCKING_NOTIFIER_HEAD(bimc_freq_min_notifier);
static struct pm_qos_constraints bimc_freq_min_constraints = {
	.list = PLIST_HEAD_INIT(bimc_freq_min_constraints.list),
	.target_value = PM_QOS_BIMC_FREQ_MIN_DEFAULT_VALUE,
	.default_value = PM_QOS_BIMC_FREQ_MIN_DEFAULT_VALUE,
	.type = PM_QOS_MAX,
	.notifiers = &bimc_freq_min_notifier,
};
static struct pm_qos_object bimc_freq_min_pm_qos = {
	.constraints = &bimc_freq_min_constraints,
	.name = "bimc_freq_min",
};

static BLOCKING_NOTIFIER_HEAD(bimc_freq_max_notifier);
static struct pm_qos_constraints bimc_freq_max_constraints = {
	.list = PLIST_HEAD_INIT(bimc_freq_max_constraints.list),
	.target_value = PM_QOS_BIMC_FREQ_MAX_DEFAULT_VALUE,
	.default_value = PM_QOS_BIMC_FREQ_MAX_DEFAULT_VALUE,
	.type = PM_QOS_MIN,
	.notifiers = &bimc_freq_max_notifier,
};
static struct pm_qos_object bimc_freq_max_pm_qos = {
	.constraints = &bimc_freq_max_constraints,
	.name = "bimc_freq_max",
};
...
static struct pm_qos_object *pm_qos_array[] = {
	...
	&bimc_freq_min_pm_qos,
	&bimc_freq_max_pm_qos,
	&touch_press_pm_qos,
	&touch_move_pm_qos,
