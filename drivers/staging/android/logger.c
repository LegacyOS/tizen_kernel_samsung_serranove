...
static unsigned char _buf_log_main[CONFIG_LOGCAT_SIZE*1024];
static unsigned char _buf_log_events[CONFIG_LOGCAT_SIZE*1024];
static unsigned char _buf_log_radio[CONFIG_LOGCAT_SIZE*1024];
static unsigned char _buf_log_system[CONFIG_LOGCAT_SIZE*1024];
#endif
