...
#if defined(CONFIG_SEC_KLEOS_PROJECT) || defined(CONFIG_SEC_KIRANLTE_PROJECT) || \
	defined(CONFIG_SEC_GRANDPRIME_PROJECT) || defined(CONFIG_SEC_J5LTE_PROJECT) || \
                         ...
                         const char *buf, size_t count)
{
	...
	defined(CONFIG_SEC_KIRANLTE_PROJECT) || defined(CONFIG_SEC_GRANDPRIME_PROJECT) || \
...
#if defined(CONFIG_SEC_KLEOS_PROJECT) || defined(CONFIG_SEC_KIRANLTE_PROJECT) || defined(CONFIG_SEC_GRANDPRIME_PROJECT) || \
	defined(CONFIG_SEC_J5LTE_PROJECT) || defined(CONFIG_SEC_MILLET_PROJECT)
