...
*    To use this macro define USE_TRACE and set bit 0 of smsc_debug_mode
*******************************************************/
#ifdef USING_LINT
extern void SMSC_TRACE(unsigned long dbgBit, const char * a, ...);
#else //not USING_LINT
#ifdef USE_TRACE
extern u32 smsc_debug_mode;
#ifndef USE_WARNING
#define USE_WARNING
#endif
#   define SMSC_TRACE(dbgBit,msg,args...)   \
    if(smsc_debug_mode&dbgBit) {                 \
...
*      USE_WARNING and set bit 1 of smsc_debug_mode
*******************************************************/
...
#   define SMSC_WARNING(msg, args...)               \
    if(smsc_debug_mode&DBG_WARNING) {                    \
