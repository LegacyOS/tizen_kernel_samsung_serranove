...
#include "mpu6k_input.h"

#define DEFAULT_MPU_SLAVEADDR		0x68
#define MPU6500_INPUT_DRIVER "mpu6500"
...
/*---- MPU6050B1 'ACCEL_CONFIG2' register (1D) ----*/
...
#define	BIT_STBY_ACCEL		(BIT_STBY_XA | BIT_STBY_YA | BIT_STBY_ZA)
#define	BIT_STBY_GYRO		(BIT_STBY_XG | BIT_STBY_YG | BIT_STBY_ZG)
#define	BIT_STBY_ALL		(BIT_STBY_ACCEL | BIT_STBY_GYRO)
...
/*
struct mpu6500_input_platform_data {
	__s8 orientation[9];
};*/
...
#define MAX_THRESHOLD	0xff /*1020mg = 255*4 */
...
#define MPU6500_SENSOR_ACCEL	(0x000f)
#define MPU6500_SENSOR_GYRO		(0x00f0)
#define MPU6500_SENSOR_LPSO		(0x0100)
#define MPU6500_SENSOR_LPBC		(0x0200)
#define MPU6500_SENSOR_PEDO		(0x0400)

#define INT_SRC_ORIENT 0x02
#define INT_SRC_DISPLAY_ORIENT  0x08
#define INT_SRC_SCREEN_BRIGHTNESS  0x10
#define DMP_MASK_DIS_ORIEN       0xC0
#define DMP_DIS_ORIEN_SHIFT      6

#define IS_LP_ENABLED(sensors) \
	(sensors & (MPU6500_SENSOR_LPSO | MPU6500_SENSOR_LPBC\
		|MPU6500_SENSOR_PEDO))
#define LP_MASK(sensors) \
	(sensors & (MPU6500_SENSOR_LPSO | MPU6500_SENSOR_LPBC\
		|MPU6500_SENSOR_PEDO))

#define LP_NEEDS_FIFO(sensors) \
	(sensors & (MPU6500_SENSOR_LPSO | MPU6500_SENSOR_LPBC))

#define LP_NEEDS_ACCEL(sensors) \
	(sensors & (MPU6500_SENSOR_LPSO | MPU6500_SENSOR_LPBC\
		|MPU6500_SENSOR_PEDO))

#define LP_SLEEPABLE_SENSOR(sensors) \
	(sensors & (MPU6500_SENSOR_ACCEL | MPU6500_SENSOR_GYRO \
		|MPU6500_SENSOR_LPSO | MPU6500_SENSOR_LPBC))
...
#define mpu_info(str, args...)\
	pr_info("[MPU-6500] %s: " str, __func__, ##args)
#define mpu_err(str, args...)\
	pr_err("[MPU-6500] %s: " str, __func__, ##args)
