...
#define SensorConfigScript uint16_t

SensorConfigScript sr352_Init_Reg[] = {
...
SensorConfigScript sr352_Capture_640_480[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Capture_960_720[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Capture_1280_720[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Capture_1280_960[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Capture_1536_864[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Capture_1600_1200[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Capture_2048_1152[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Capture_2048_1536[] ={
0x03c8,	//AWB Off
0x1052,
...
SensorConfigScript sr352_Enterpreview_640x480[] ={
...
SensorConfigScript sr352_Enterpreview_800x480[] ={
...
SensorConfigScript sr352_Enterpreview_1024x768[] ={
...
SensorConfigScript sr352_preview_176_144[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_320_240[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_352_288[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_528_432[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_640_480[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_720_480[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_800_480[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_800_600[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_1024_576[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
SensorConfigScript sr352_preview_1024_768[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01,
...
/*============================================*/
#if 1
SensorConfigScript sr352_recording_50Hz_HD[] = {
...
//I2CD set
0x0326,//Xdata mapping for I2C direct E0 page Original.
0xd026,
0xd154,
...
//I2CD set
0x0326,//Xdata mapping for I2C direct E3 page Origianl.
0xd62a,
0xd70c,
...
//I2CD set
0x0326, //Xdata mapping for I2C direct E6 page Original.
0xdc2d,
0xddc4,
...
//I2CD set
0x0326,//Xdata mapping for I2C direct E9 page Original.
0xe231,
0xe37c,
...
SensorConfigScript sr352_recording_50Hz_30fps[] = {
...
SensorConfigScript sr352_recording_50Hz_25fps[] = {
...
SensorConfigScript sr352_recording_50Hz_15fps[] = {
...
SensorConfigScript sr352_recording_50Hz_modeOff[] = {
 ...
 *CAMERA_BRIGHTNESS_1 (1/9) M4   *
 ==================================*/
SensorConfigScript sr352_bright_m4[] =
{
0x0310,
0x1403,
0x5d40,
...
SensorConfigScript sr352_bright_m3[] =
{
0x0310,
0x1403,
0x5d54,
...
/*=================================
  ...
  ==================================*/
SensorConfigScript sr352_bright_m2[] =
{
0x0310,
0x1403,
0x5d67,
...
SensorConfigScript sr352_bright_m1[] =
{
0x0310,
0x1403,
0x5d7b,
...
/*=================================
  ...
  ==================================*/
SensorConfigScript sr352_bright_default[] =
{
0x0310,
0x1402,
0x5d80,
...
/*=================================
  ...
  ==================================*/
SensorConfigScript sr352_bright_p1[] =
{
0x0310,
0x1403,
0x5d86,
...
/*=================================
  ...
  ==================================*/
SensorConfigScript sr352_bright_p2[] =
{
0x0310,
0x1403,
0x5d99,
...
/*=================================
  ...
  ==================================*/
SensorConfigScript sr352_bright_p3[] =
{
...
/*=================================
  ...
  ==================================*/
SensorConfigScript sr352_bright_p4[] =
{
0x0310,
0x1403,
0x5dc0,
 ...
 *CAMERA_SATURATION_-2 (1/5) m2   *
 ==================================*/
SensorConfigScript sr352_saturation_m2[]=
{
//level -2
0x03d3,
0x7bc0,	// Cb offset
 ...
 *CAMERA_SATURATION_-1 (2/5) m1   *
 ==================================*/
SensorConfigScript sr352_saturation_m_1[] =
{
//level -1
0x03d3,
0x7ba0,	// Cb offset
 ...
 *CAMERA_SATURATION_0 (3/5) default   *
 ==================================*/
SensorConfigScript sr352_saturation_0[] =
{
//level 0
0x03d3,
0x7b00,	// Cb offset
 ...
 *CAMERA_SATURATION_1 (4/5) p1   *
 ==================================*/
SensorConfigScript sr352_saturation_p_1[] =
{
//level 1
0x03d3,
0x7b20,	// Cb offset
 ...
 *CAMERA_SATURATION_2 (5/5) p2   *
 ==================================*/
SensorConfigScript sr352_saturation_p_2[] =
{
//level 2
0x03d3,
0x7b40,	// Cb offset
 ...
 *CAMERA_CONTRAST_-2 (1/5) m2   *
 ==================================*/
SensorConfigScript sr352_contrast_m_2[]=
{
//level -2
0x0310,
 ...
 *CAMERA_CONTRAST_-1 (2/5) m1   *
 ==================================*/
SensorConfigScript sr352_contrast_m_1[]=
{
//level -1
0x0310,
0x1302, //Contrast enable
 ...
 *CAMERA_CONTRAST_0 (3/5) default   *
 ==================================*/
SensorConfigScript sr352_contrast_0[]=
{
//level 0
0x0310,
 ...
 *CAMERA_CONTRAST_1 (4/5) p1   *
 ==================================*/
SensorConfigScript sr352_contrast_p_1[]=
{
//level 1
0x0310,
0x1302, //Contrast enable
 ...
 *CAMERA_CONTRAST_2 (5/5) p2   *
 ==================================*/
SensorConfigScript sr352_contrast_p_2[]=
{
//level 2
0x0310,
0x1302, //Contrast enable
...
SensorConfigScript sr352_effect_none[] =
{
0x0310,
0x1103,
0x1210,
...
SensorConfigScript sr352_effect_gray[] =
{
0x0310,
0x1103,
0x12f3,
...
SensorConfigScript sr352_effect_negative[] =
{
0x0310,
0x1103,
0x12f8,
...
SensorConfigScript sr352_effect_sepia[] =
{
0x0310,
0x1103,
0x12f3,
...
SensorConfigScript sr352_wb_auto[] =
{
0x03c8,
0x1052, //AWB Off
...
SensorConfigScript sr352_wb_cloudy[] =
{
	0x03c8,
	0x1052, //AWB Off
...
SensorConfigScript sr352_wb_fluorescent[] =
{
	0x03c8,
	0x1052, //AWB Off
	0x1220, //Adaptive e0, manual 20
...
SensorConfigScript sr352_wb_incandescent[] =
{
	0x03c8,
	0x1052, //AWB Off
	0x1220, //Adaptive e0, manual 20
...
SensorConfigScript sr352_wb_sunny[] =
{
	0x03c8,
	0x1052, //AWB Off
	0x1220, //Adaptive e0, manual 20
...
/*CAMERA_SCENE_off                         */
/*===========================================*/
SensorConfigScript sr352_SceneOff[] =
{
...
/*===========================================*/
SensorConfigScript sr352_Landscape[] =
{
...
/*CAMERA_SCENE_Party                       */
/*===========================================*/
SensorConfigScript sr352_Party[] =
{
...
/*CAMERA_SCENE_sunset                      */
/*===========================================*/
SensorConfigScript sr352_Sunset[] =
{
...
/*===========================================*/
SensorConfigScript sr352_Nightshot[] =
{
...
/*===========================================*/
SensorConfigScript sr352_Backlight[] =
{
...
/*CAMERA_SCENE_Candle                      */
/*===========================================*/
SensorConfigScript sr352_Candle[] =
{
...
/*CAMERA_SCENE_Beach      */
/*===========================================*/
SensorConfigScript sr352_Beach[] =
{
...
/*CAMERA_SCENE_Sports              */
/*===========================================*/
SensorConfigScript sr352_Sports[] =
{
...
/*===========================================*/
SensorConfigScript sr352_Firework[] =
{
...
/*===========================================*/
SensorConfigScript sr352_Portrait[] =
{
...
/*METERING()                                               */
/*=========================================================*/
SensorConfigScript sr352_metering_matrix[] = {
...
SensorConfigScript sr352_metering_center[] = {
...
SensorConfigScript sr352_metering_spot[] = {
...
SensorConfigScript sr352_stream_stop[] = {
	0x03c1,
	0x1006, // ssd tranfer disable
	0xff01,
...
SensorConfigScript sr352_50hz_setting[] = {
...
SensorConfigScript sr352_60hz_setting[] = {
