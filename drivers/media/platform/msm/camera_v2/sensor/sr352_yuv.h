...
#define FLASH_PGARO                           0x20AB
#define FLASH_CTL1                            0x266A
#define FLASH_CALCRATIOTH                     0x266B
#define FLASH_CALCRATIOMAX                    0x266C
#define FLASH_PGATH                           0x266D
#define FLASH_PRE_FLASHRATE                   0x266E
#define FLASH_MAIN_FLASHRATE                  0x266F

#define FLASH_AWB_YDIFF                       0xC86F
#define FLASH_AWB_TGTRGAIN                    0xC870
#define FLASH_AWB_TGTGGAIN                    0xC872
#define FLASH_AWB_TGTBGAIN                    0xC874

#define XAXIS_START                           96
#define YAXIS_START                           96
#define LCD_X                                 (927 - XAXIS_START)
#define LCD_Y                                 (672 - XAXIS_START)

#define SR352_READ_ADDR(A,B) \
    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_read( \
            s_ctrl->sensor_i2c_client,A, B, MSM_CAMERA_I2C_BYTE_DATA)

#define SR352_WRITE_ADDR(A,B) \
...
typedef struct{
    ...
    uint16_t bState;
    ///////////////////////////////////////
    // Read only register For AE
    ///////////////////////////////////////
    //Org data
    uint32_t	dwOrgEvRO;
    uint32_t	dwOrgEv;
    uint32_t	dwOrgExptime;
    uint16_t	bOrgPga;
    uint16_t	bOrgDg;
    uint16_t	bOrgY;
    uint16_t	bOrgTgt;
    //Pre flash data
    uint32_t	dwPreFlashEv;
    uint32_t	dwPreExptime;
    uint16_t	bPrePga;
    uint16_t	bPreDg;
    uint16_t	bPreFlashY;
    uint16_t	bPreFlashTgt;
    uint16_t	bFlashCtl1;
    uint16_t	bFlashCalcRatioTh;
    uint16_t	bFlashCalcRatioMax;
    uint16_t	bPFlashRate;
    uint16_t	bMFlashRate;
    uint16_t	bDgRatio;
    uint16_t	bDgCtl;
    uint16_t	bAntiFlag;
    uint16_t	bAgMax;
    ...
    // Cal register For AE
    ///////////////////////////////////////
    uint32_t fPreFlash_Ymean;
    uint32_t fPreFlash_Yinc;
    uint32_t fPreFlash_YDiff;
    uint32_t fMainFlash_Rate;
    uint32_t fMainFlash_Ymean;
    uint32_t fYcalRate;
    uint32_t fMainFlashAg;
    uint32_t fMainFlashDg;
    uint32_t fAgMin;
    uint32_t fAgMax;
    uint32_t fDgMin;
    uint32_t fDgMax;
    uint32_t fFlashCalcRatio;
    uint32_t dwMainFlashEv;
    uint32_t dwMainFlashBandStep;
    uint32_t dwMainFlashExp;
    uint16_t  bMainFlashAg;
    uint16_t  bMainFlashDg;
    ///////////////////////////////////////
    // Read only register For AWB
    ///////////////////////////////////////
    uint16_t bYdiffTh;
    uint16_t wTgtRgain;
    uint16_t wTgtGgain;
    ...
    uint16_t wOrgGgain;
    uint16_t wOrgBgain;
    uint16_t wPreFlashRgain;
    uint16_t wPreFlashGgain;
    uint16_t wPreFlashBgain;
    uint16_t wRgainMin;
    uint16_t wRgainMax;
    uint16_t wBgainMin;
    uint16_t wBgainMax;
    ...
    uint16_t wOrgBgTgt;
    ///////////////////////////////////////
    // Cal register For AWB
    ///////////////////////////////////////
    uint32_t fYdiffRatio;
    uint16_t wMainFlashRgain;
    uint16_t wMainFlashGgain;
    uint16_t wMainFlashBgain;
...
{0x11, 0x80,}, //Fixed mode off //XY Flip
{0x12, 0x00,},
{0x13, 0x28,},
{0x15, 0x01,},
...
{0x11, 0x11,}, //Preview1 XY flip 1219
{0x12, 0x02,}, //Preview1 XY flip 1219
...
///////////////////////////////////////////////////////////////////////////////
{0x03, 0x0b,},
{0x11, 0x11,}, //Full XY flip 1219
{0x12, 0x00,}, //Full XY flip 1219
...
{0x03, 0x0b,},
{0x10, 0x01,}, // otp_dpc_ctl
{0x11, 0x11,}, //HD(Crop) XY flip 1219
{0x12, 0x00,}, //HD(Crop) XY flip 1219
...
#endif
static struct msm_camera_i2c_reg_conf sr352_Night_Capture_2048_1536_01[] ={

    {0x03, 0x00,},
    {0x01, 0x01,},	// Sleep on

    {0xFF, 0x0F,},  // 150ms Delay
...
static struct msm_camera_i2c_reg_conf sr352_StartPreFlash_FlashRegTable1[]={
...
static struct msm_camera_i2c_reg_conf sr352_AfterMainFlash_FlashRegTable6[]={
...
{0xFF, 0x02},      // 20ms delay(unit=10ms)
};
