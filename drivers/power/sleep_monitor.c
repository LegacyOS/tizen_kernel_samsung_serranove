...
static sleep_monitor_device slp_mon[SLEEP_MONITOR_NUM_MAX] = {
	...
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"DEV12   " }, /* SLEEP_MONITOR_DEV12 */
	...
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"VOICE   " }, /* SLEEP_MONITOR_VOICE */
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"XOSD    " }, /* SLEEP_MONITOR_RPM_XOSD */
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"VMIN    " }, /* SLEEP_MONITOR_RPM_VMIN */
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"EE_APPS " }, /* SLEEP_MONITOR_EE_APSS */
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"EE_MPSS " }, /* SLEEP_MONITOR_EE_MPSS */
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"EE_PRON " }, /* SLEEP_MONITOR_EE_PRON */
	{NULL, NULL, SLEEP_MONITOR_CHECK_HARD, SLEEP_MONITOR_BOOLEAN_FALSE,"DEV29   " }, /* SLEEP_MONITOR_DEV29 */
 ...
 int __init sleep_monitor_debug_init(void)
{
	...
	if (d) {
		...
		if (!debugfs_create_file("skip_device", 0644
			, d, NULL, &skip_device_fops))  \
				pr_err("%s : debugfs_create_file, error\n", "skip_device");

		if (!debugfs_create_file("check_device_level", 0644
			, d, NULL, &device_level_fops))  \
				pr_err("%s : debugfs_create_file, error\n", "check_device_level");

		if (!debugfs_create_file("pretty_status", 0444
			, d, NULL, &device_pretty_fops))  \
				pr_err("%s : debugfs_create_file, error\n", "pretty_status");

		if (!debugfs_create_file("monitor_interval", 0644
			, d, NULL, &monitor_interval_fops))  \
				pr_err("%s : debugfs_create_file, error\n", "monitor_interval");

		if (!debugfs_create_file("dev_name", 0644
                        , d, NULL, &dev_name_fops))  \
                                pr_err("%s : debugfs_create_file, error\n", "dev_name");

		debugfs_create_u32("debug_level", 0644, d, &debug_level);
		debugfs_create_u32("enable", 0644, d, &sleep_monitor_enable);
	}
