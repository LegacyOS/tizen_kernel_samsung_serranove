...
#ifdef CONFIG_SAMSUNG_AUDIO
static const char * const loopback_mode[] = { "OFF", "DELAY", "NO_DELAY"};
static const struct soc_enum dsp_loopback_mode_enum[] = {
	SOC_ENUM_SINGLE_EXT(3, loopback_mode),
};
#endif
static struct snd_kcontrol_new msm_voice_controls[] = {
	...
	*/
	SOC_ENUM_EXT("Loopback Enable", dsp_loopback_mode_enum[0],
				msm_loopback_get, msm_loopback_put),
#endif
};
