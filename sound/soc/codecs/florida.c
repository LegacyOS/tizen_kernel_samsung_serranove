...
#if !defined(CONFIG_SND_SOC_MSM8X16_ARIZONA)
...
{
	return snd_soc_register_platform(dev, &florida_compr_platform);
}
EXPORT_SYMBOL_GPL(florida_asoc_platform_register);

void florida_asoc_platform_unregister(struct device *dev)
{
	snd_soc_unregister_platform(dev);
}
EXPORT_SYMBOL_GPL(florida_asoc_platform_unregister);
#endif
